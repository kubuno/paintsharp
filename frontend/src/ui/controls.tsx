...
export function OptNum({ label, value, min, max, suffix, onChange, C, disabled }: {
  ...
  return (
    <label className="flex items-center gap-1" style={{ color: C.textDim, opacity: disabled ? 0.4 : 1 }}>
