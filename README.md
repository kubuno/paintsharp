...
<table>
  ...
  <tbody>
    <tr>
      <td align="center"><img src=".github/logo-layer.png" width="24" height="24" alt=""></td>
      <td><b>Layer</b></td>
      <td><code>/paintsharp/layer</code></td>
      <td>Raster / image editor</td>
    </tr>
    <tr>
      <td align="center"><img src=".github/logo-apex.png" width="24" height="24" alt=""></td>
      <td><b>Apex</b></td>
      <td><code>/paintsharp/apex</code></td>
      <td>Vector editor (paths, nodes, gradients, image tracing)</td>
    </tr>
    <tr>
      <td align="center"><img src=".github/logo-vertex.png" width="24" height="24" alt=""></td>
      <td><b>Vertex</b></td>
      <td><code>/paintsharp/vertex</code></td>
      <td>3D editor (modeling, sculpting, CSG booleans)</td>
    </tr>
    <tr>
      <td align="center"><img src=".github/logo-motion.png" width="24" height="24" alt=""></td>
      <td><b>Motion</b></td>
      <td><code>/paintsharp/motion</code></td>
      <td>Video editor (multi-track timeline, transitions, export)</td>
    </tr>
    <tr>
      <td align="center"><img src=".github/logo-keyframe.png" width="24" height="24" alt=""></td>
      <td><b>Keyframe</b></td>
      <td><code>/paintsharp/keyframe</code></td>
      <td>2D frame-by-frame animation</td>
    </tr>
    <tr>
      <td align="center"><img src=".github/logo-pdfwriter.png" width="24" height="24" alt=""></td>
      <td><b>PdfWriter</b></td>
      <td><code>/paintsharp/pdfwriter</code></td>
      <td>PDF editor (import & edit content, signatures, OCR)</td>
    </tr>
    <tr>
      <td align="center"><img src=".github/logo-fonteditor.png" width="24" height="24" alt=""></td>
      <td><b>FontEditor</b></td>
      <td><code>/paintsharp/fonteditor</code></td>
      <td>Type design (glyph drawing, metrics, kerning, font export)</td>
    </tr>
  </tbody>
</table>
...
- **Motion** — a multi-track video timeline (video, audio and image tracks) with trimming, splitting and transitions, a live preview engine and export to WebM/MP4 straight from the browser.
- **Keyframe** — frame-by-frame 2D animation on a timeline with onion skinning and a configurable frame rate; each frame is drawn with the real Apex and Layer editors mounted in place, so every tool they gain is available here, and animations export as video.
...
Rust 2021 · Axum · Tokio · `kubuno-db` over SQLx (PostgreSQL, MySQL/MariaDB or SQLite) — React 19 · TypeScript · Vite · Tailwind CSS v4 · Zustand · React Query · Yjs · Three.js.
