...
#   /usr/lib/kubuno/modules/paintsharp/{kubuno-paintsharp, module.toml, frontend/}
#   /usr/share/kubuno/modules/paintsharp/migrations/*.sql
#   /etc/kubuno/modules/paintsharp/config.toml.example
#
# Usage :
